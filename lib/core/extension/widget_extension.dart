...
extension WidgetExtensionX on Widget {
  ...
  SliverPadding sliverPadding(EdgeInsets insets) => SliverPadding(padding: insets, sliver: toSliverBox);

  Padding pad(double pad) => Padding(padding: EdgeInsets.all(pad), child: this);
